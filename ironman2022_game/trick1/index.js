...
/**先看看原本的光劍抽中率 */
console.log('原光劍比重 => ' + ((itemToChange === null || itemToChange === void 0 ? void 0 : itemToChange.weight) / totalWeight));
/**定義光劍的新抽中率為0.5，以及扣掉光劍後的總繩長T */
let P = 0.5;
let T = totalWeight - (itemToChange === null || itemToChange === void 0 ? void 0 : itemToChange.weight);
/**依公式，光劍的新比動W就可以算出來*/
let W = P / (1 - P) * T;
(itemToChange === null || itemToChange === void 0 ? void 0 : itemToChange.weight) != W;
/**別忘了最後履把新的光僉比動加回totalWeight */
totalWeight = T + W;
console.log('新的比重總值 =>', +totalWeight);
console.log('新光劍比重 =>' + (itemToChange === null || itemToChange === void 0 ? void 0 : itemToChange.weight));
console.log('光劍抽中率 =>' + ((itemToChange === null || itemToChange === void 0 ? void 0 : itemToChange.weight) / totalWeight));
